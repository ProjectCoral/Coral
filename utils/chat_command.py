...
class ChatCommand:
    ...
    async def chat_command(self, message, **kwargs):
        ...
        try:
            ...
            return {"action": "send_msg", "message": f"Error: {e}", "sender_user_id": sender_user_id, "group_id": group_id}, False, 1

        return {"action": "send_msg", "message": send_message, "sender_user_id": sender_user_id, "group_id": group_id}, False, 1
